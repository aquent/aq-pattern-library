...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;const T=new class{handleAttributeExpressions(e,t,s,i){const n=t[0];if("."===n){return new x(e,t.slice(1),s).parts}return"@"===n?[new N(e,t.slice(1),i.eventContext)]:"?"===n?[new w(e,t.slice(1),s)]:new v(e,t,s).parts}handleTextExpression(e){return new b(e)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
